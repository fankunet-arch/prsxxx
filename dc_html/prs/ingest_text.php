 ...
 * - 自动用 text/plain POST 到 API：/prs/api/ingest_bulk.php
 * - 顶部有轻量提示条（自动淡出）
 * - 右侧展示解析报告、告警与明细
 */
...
$apiBase = '/prs/api/ingest_bulk.php';
...
pera cinferebcia#@ud:0.43#@udp:166g#@pkg:2.6#@"></textarea>
      ...
      <div class="kv" style="align-items:flex-start; margin-top: 16px;">
        ...
        <div class="stack" style="flex:1">
            <textarea id="aiPromptHelper" class="code" rows="12" readonly><?= htmlspecialchars($aiPrompt) ?></textarea>
            <button class="btn secondary" id="btnCopyPrompt" style="width:100px;align-self:flex-end;margin-top:-5px">复制提示词</button>
        </div>
      </div>
      </div>
  </div>
