...
<div class="stack" style="gap:16px">
  ...
  <div class="card" style="border-radius:16px">
    <div class="body">
      <canvas id="chart" width="960" height="320" style="width:100%;height:320px"></canvas>
      <div class="muted" id="hint" style="margin-top:6px">浅绿：当月在市；淡红：缺货段；折线：€/kg</div>
    </div>
  </div>

  <div id="tableWrap" style="overflow:auto;max-height:420px;display:none">
